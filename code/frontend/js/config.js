...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $urlRouterProvider.otherwise("/profiles/OTE");
//	$urlRouterProvider.otherwise("/OTE");
    ...
    $stateProvider
        ...
        .state('dashboards.dashboard_2', {
            url: "/dashboard_2",
            templateUrl: "views/dashboard_2.php",
        ...
        .state('profiles.ORACLE', {
            url: "/ORACLE",
            templateUrl: "views/ORACLE.php",
